...
public class CameraSource {
    ...
    private OnFrameReceivedListener mOnFrameReceivedListener;
    ...
    public void setOnFrameReceivedListener(OnFrameReceivedListener onFrameReceivedListener) {
        mOnFrameReceivedListener = onFrameReceivedListener;
    }
    ...
    /**
     * Callback interface used to signal the moment of receiving frame with detector.
     */
    public interface OnFrameReceivedListener {

        /**
         * Called when detector receives frame
         */
            ...
            while (true) {
                ...
                try {
                    ...
                    if (mOnFrameReceivedListener != null) {
                        mOnFrameReceivedListener.onFrameReceived();
                    }
                } catch (Throwable t) {
